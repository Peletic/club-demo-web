...
export default function PathfinderGrid({mapState, setMapState, width, height}) {
    ...
    return (<div className={`grid grid-cols-1 gap-1 min-w-[45%] w-64 p-4 mx-auto`} style={{gridTemplateColumns: `repeat(${width}, minmax(0, 1fr))`, gridTemplateRows: `repeat(${height}, minmax(0,1fr))`}} onContextMenu={e => e.preventDefault()}>
